      ...
      <div className="container mx-auto px-4 py-16 max-w-6xl relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          <div className="text-center lg:text-left space-y-6">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold" style={{ fontFamily: 'Playfair Display, serif' }}>
              Ashan{' '}
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
              <a
                href="#contact"
                className="flex items-center justify-center gap-2 px-4 py-2 text-sm bg-sky-400 text-white font-semibold rounded-lg hover:bg-sky-300 hover:text-slate-800 transition-all shadow-lg shadow-sky-400/20"
              >
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 px-4 py-2 text-sm bg-white/10 border border-sky-300/50 text-sky-100 font-semibold rounded-lg hover:bg-sky-300/20 transition-all"
              >
